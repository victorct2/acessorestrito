        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo $this->noticiasDao_model->totalNoticias() ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo $this->noticiasDao_model->totalNoticias(true,false) ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo $this->noticiasDao_model->totalNoticias(false,true) ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
                ...
                <tr class="busca">                  
                  ...
                  <th>
                      <select  data-column="4" class="form-control search-input-select-informacao" style="width: 80%;">
                        ...
                        <option value="NOTICIA">Apenas Notícias</option>
                        <option value="RELEASE">Apenas Release</option>
                        <option value="NOTICIARELEASE">Notícia e Release</option>
