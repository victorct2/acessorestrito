    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-md-6">      
            ...
            <div class="box box-default">
              <div class="box-header with-border">
                <h3 class="box-title">Costureira</h3>
                <span class="label pull-rigth bg-maroon total">Total: <?php echo $this->figurinoDao_model->totalServico($figurino[0]->idFigurino,'C') ?>  </span>
                ...
                <div id="saidaFigurino" class="col-md-6 collapse" >      
                        ...
                        <form action="<?php echo base_url('FigurinoController/cadastrarCostureira')?>" method="POST">
                            <!-- Date range -->
                            <div class="form-group">
              ...
              <div class="box-body">
                    ...
                    <?php foreach ($listCostureira as $value) { ?>
