<div class="modal-dialog modal-lg">
  ...
  <form action="<?php echo base_url()?>RevisaoClosedCaptionController/revisaoCatalogacaoCorrecao" method="post" >  
      <div class="modal-header">
        ...
        <hr />
        <h4 class="modal-title">Revisar Correção de Catalogação de Closed Caption <i class="fa fa-cc" aria-hidden="true"></i> -  <?php echo $ingest[0]->tituloPrograma?></h4>
      ...
      <div class="modal-body">
          ...
          <div class="panel panel-default">
            ...
            <input type="hidden" name="idRevisaoCatalogacaoClosedCaption" value="<?php echo $revisaoClosedCaption[0]->idRevisaoCatalogacaoClosedCaption ?>"/>
