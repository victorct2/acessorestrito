<div class="modal-dialog modal-lg">
  ...
  <form action="<?php echo base_url()?>RevisaoClosedCaptionController/revisaoCorrecao" method="post" >  
      <div class="modal-header">
        ...
        <hr />
        <h4 class="modal-title">Revisar Correção de Closed Caption <i class="fa fa-cc" aria-hidden="true"></i> -  <?php echo $ingest[0]->tituloPrograma?></h4>
      ...
      <div class="modal-body">
          ...
          <div class="panel panel-default">
            <div class="panel-heading">Revisão de Closed Caption:</div>
            <div class="panel-body">
                    ...
                    foreach ($problemaClosedCaption as $problema) { ?>										
                      <div class="form-group observacaoClaquete">
                          ...
                          <div class="col-sm-6">
                            ...
                            <input type="hidden" name="idRevisaoClosedCaptionProblema" value="<?php echo $problema->idRevisaoClosedCaptionProblema ?>">
                          </div>
                          <div class="col-sm-6">
            ...
            <input type="hidden" name="idRevisaoClosedCaption" value="<?php echo $revisaoClosedCaption[0]->idRevisaoClosedCaption ?>"/>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary">Cadastrar Revisão de Correção de Ingest Closed Caption</button>
      </div>
    </form>
  </div>
  <!-- /.modal-content -->
