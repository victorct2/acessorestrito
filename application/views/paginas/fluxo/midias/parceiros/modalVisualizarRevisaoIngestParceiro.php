      ...
      <div class="modal-body">
          ...
          <div class="panel panel-default">
							...
							<ul class="list-group">
							  <?php foreach ($claquetes as $claquete) {?>								  	
								  <li class="list-group-item">								  
								  	<?php  if($claquete->statusRevisao == 'APROVADO'){?>
								     	 		<small class="label label-success pull-right">Aprovado</small>
								     	 		
								    <?php }else if($claquete->statusRevisao == 'REPROVADO'){?>
                      ...
                      <div class="panel-body">
                        <div class="form-group">										    
                          <?php						
                            $problemasClaquete = $this->revisaoDao->selectProblemas($ingest[0]->idIngest,$claquete->idClaqueteRevisao,'I','C')	;	
          ...
          <div class="panel panel-default">
						...
						<div class="panel-body">
							<ul class="list-group">
							  <?php foreach ($blocos as $bloco) {?>								  	
								  <li class="list-group-item">								  
								  	<?php  if($bloco->statusRevisao == 'APROVADO'){?>
								     	 		<small class="label label-success pull-right">Aprovado</small>
								     	 		
								    <?php }else if($bloco->statusRevisao == 'REPROVADO'){?>
								    	 		<small class="label label-danger pull-right">Reprovado</small>								    	 		
								    <?php } 							    								    	 
                      ...
                      <div class="panel-body">
                        <div class="form-group">										    
                          <?php						
                            $problemasBloco = $this->revisaoDao->selectProblemas($ingest[0]->idIngest,$bloco->idBlocoRevisao,'I','B')	;	
