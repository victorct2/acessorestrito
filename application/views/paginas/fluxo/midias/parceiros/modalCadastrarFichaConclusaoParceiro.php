<div class="modal-dialog modal-lg">
  <div class="modal-content">
    <form action="<?php echo base_url('FichaConclusaoController/cadastrarFichaConclusao') ?>" method="POST">
      ...
      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          ...
          <hr />
          <h4 class="modal-title">Cadastro de Ficha de Conclusão de Programa Parceiro -  <b><?php echo $ingest[0]->tituloPrograma?></b></h4>
      </div>
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input name="dataVeiculacao" type="date" class="form-control" id="dataVeiculacao" placeholder="Data de Veiculação" value="">
                </div>
                <div class="form-group">
                    <label for="duracaoReal">Duração real :</label>
                    <input name="duracaoReal" type="text" class="form-control" id="duracaoReal" placeholder="Duração real" data-inputmask='"mask": "99:99:99"' data-mask>
                </div>
                  ...
                  <div class="panel-body">
                    <?php foreach ($blocos as $key => $bloco) { ?>
                      <div class="form-group">
                          ...
                          <input type="text" name="bloco[<?php echo $bloco->idBlocoRevisao?>][]" class="form-control" id="bloco" placeholder="Duração do Bloco" data-inputmask='"mask": "99:99:99"' data-mask required >                        
                      </div>  
                    <?php } ?>				    					
                  </div>
                </div>
                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                      <div class="form-group">
                        ...
                        <input type="text" name="apresentadores" class="form-control" id="apresentadores" placeholder="Apresentadores" value="" >                      
                      </div>
                      <div class="form-group">
                          <label for="diretor">Diretor(es):</label><br>                          
                          <input type="text" name="diretor" class="form-control" id="diretor" placeholder="Diretor" value="" >                          
                      </div>
                      <div class="form-group">
                          <label for="reporter">Repórter:</label><br>                       
                          <input type="text" name="reporter" class="form-control" id="reporter" placeholder="Repórter" value="" >                         
                      </div>
                      <div class="form-group">
                          <label for="produtor">Produtor(es):</label><br>                         
                          <input type="text" name="produtor" class="form-control" id="produtor" placeholder="Produtor" value="" >                          
                      </div>
                  </div>
                </div>
                    ...
                    <div class="panel-body">
                      <div class="form-group">
                        <label for="convidados">Convidados:</label><br>                       
                          <textarea name="convidados" rows="3"  class="form-control" id="convidados" placeholder="Convidados"  ></textarea>                       
                      </div>
                      <div class="form-group">
                          <label for="tags">Tags do Programa:</label><br>                          
                          <textarea name="tags" rows="3"  class="form-control" id="tags" placeholder="Tags"  required></textarea>                         
                      </div>
                      <div class="form-group">
                          <label for="sinopse">Sinopse do Programa:</label><br>
                          <textarea name="sinopse" rows="3"  class="form-control" id="sinopse" placeholder="Sinopse do Programa"  required></textarea>                         
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                      <div class="form-group">
                        ...
                        <textarea name="observacao" class="form-control" id="observacao" placeholder="Observações" rows="3" ></textarea>                        
                      </div>
                    </div>
                  </div>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-warning">Cadastrar Ficha Conclusão</button>
      </div>
    </form>
  </div>
  <!-- /.modal-content -->
