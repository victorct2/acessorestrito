<div class="modal-dialog modal-lg">
  <div class="modal-content">
    <form action="<?php echo base_url('RevisaoClosedCaptionController/cadastrarRevisao') ?>" method="POST">
      <div class="modal-header">
        ...
        <hr />
        <h4 class="modal-title">Revisar Ingest Closed Caption <i class="fa fa-cc" aria-hidden="true"></i> -  <?php echo $ingest[0]->tituloPrograma?></h4>
