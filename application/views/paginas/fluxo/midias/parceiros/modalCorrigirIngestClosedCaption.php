<div class="modal-dialog modal-lg">
  ...
  <form action="<?php echo base_url()?>IngestController/corrigirIngestClosedCaption" method="post" >  
      <div class="modal-header">
        ...
        <hr />
        <h4 class="modal-title">Corrigir Ingest Closed Caption <i class="fa fa-cc" aria-hidden="true"></i>  -  <?php echo $ingest[0]->tituloPrograma?></h4>
