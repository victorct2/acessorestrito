    ...
    <br />
     ...
     <?php
                    ...
                    <div class="list-group-item checkbox">
                        <label><input type="checkbox" class="common_selector descricao_data" value="<?php echo $row['descricao']; ?>"  > <?php echo $row['descricao']; ?></label>
                    </div>
                    <?php
                    }
                    ?>
...
$(document).ready(function(){
    ...
    function filter_data(page)
    {
        ...
        $.ajax({
            url:"<?php echo base_url(); ?>product_filter2/fetch_data/"+page,
            method:"POST",
            dataType:"JSON",
