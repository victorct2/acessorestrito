<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <form action="<?php echo base_url('ComoAssistirController/alterarTextoOiTv') ?>" method="POST">
        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            ...
            <input type="hidden" name="idOiTv" value="<?php echo $textoOiTv[0]->idOiTv ?>">
