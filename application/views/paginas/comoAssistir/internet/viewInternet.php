<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Como Assistir <small>Internet</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
      ...
      <form action="<?php echo base_url('ComoAssistirController/alterarTextoInternet') ?>" method="POST">
        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            ...
            <input type="hidden" name="idInternet" value="<?php echo $textoInternet[0]->idInternet ?>">
                ...
                <div class="box-body pad">
                  <form>
                        <textarea id="editor1" name="texto" rows="10" cols="80">
                            <?php echo $textoInternet[0]->texto ?>
                        </textarea>
                  </form>
                </div>
                <hr>
