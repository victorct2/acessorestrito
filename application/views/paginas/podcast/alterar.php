	     ...
	     <div class="row">
            ...
            <div class="col-md-3">
              <div class="box box-primary box-solid">
                <div class="box-header with-border">
                  <h3 class="box-title">Imagem Podcast</h3>
                  <div class="box-tools pull-right">
                    <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                  </div><!-- /.box-tools -->
                </div><!-- /.box-header -->
                <div class="box-body">
                  <?php if($podcast[0]->imagem != ''){ ?>
                    <p id="img_<?php echo $podcast[0]->id ?>">
                      <img src="<?php echo base_url().'assets/img/podcast/'. $podcast[0]->imagem?>" class="img-responsive img-thumbnail imgAlign" width="250" height="150">
            ...
            <div class="col-md-3">
              <div class="box box-warning box-solid">
                ...
                <div class="box-body">
                  <?php if($podcast[0]->imagemApp != ''){ ?>
                    <p id="imgApp_<?php echo $podcast[0]->id ?>">
                      <img src="<?php echo base_url().'assets/img/podcast/app/'. $podcast[0]->imagemApp?>" class="img-responsive img-thumbnail imgApp imgAlign" width="200" height="100">
                      <a href="#" class="excluirImagemApp" id="<?php echo $podcast[0]->id ?>">
                          <span class="fa-stack fa-lg">
                              <i class="fa fa-square-o fa-stack-2x text-red"></i>
                              <i class="fa fa-trash  fa-stack-1x text-red"></i>
                          </span>			                 				
