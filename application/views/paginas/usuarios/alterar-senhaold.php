    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
          ...
          <form action="<?php echo base_url('AlterarSenha/alterarSenha') ?>" method="POST">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                  ...
                  <input type="text" name="nome" class="form-control" id="nome" placeholder="Informe o nome" value="">
              </div>
