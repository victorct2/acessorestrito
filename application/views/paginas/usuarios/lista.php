        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo $this->usuariosDao_model->totalUsuarios() ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo $this->usuariosDao_model->totalUsuarios(true,false) ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo $this->usuariosDao_model->totalUsuarios(false,true) ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
            ...
            <table id="listaUsuarios" class="table table-bordered table-striped dt-responsive">
              ...
              <thead>
                <tr class="busca">
                  ...
                  <th>
                    <select data-column="4" class="form-control select2 search-input-select-grupo" style="width: 100%;">
                      <option value="">Selecione ...</option> 
                      <?php foreach ($listGrupos as $value) { ?>
                            <option value="<?php echo $value->id ?>" ><?php echo $value->nome ?></option>  
                      <?php } ?>                                     
                    </select>
                  </th>
                  <th><input type="text" data-column="5" class="form-control search-input-text"  placeholder="pesquisar email ..." style="width:100%;"></th>
                  <th>
                      <select  data-column="6" class="form-control search-input-select-informacao" style="width: 80%;">
                      <option value="">Selecione ...</option> 
