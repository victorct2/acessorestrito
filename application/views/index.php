<div class="wrapper">
  ...
  <div class="container-fluid">
    <div class="hero">
      <hgroup>    
    <h1>Avisos</h1><small><?php echo date("d/m/Y");?></small>
  <br>
      </hgroup>
    </div>
...
<h3><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span><?php echo converteDataInterface($avisos->dia) .' :: '. $avisos->descricao ?> </h3>
