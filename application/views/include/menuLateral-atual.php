    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="<?php echo base_url() .'assets/img/avatar/'.$this->session->userdata("avatar")?>" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li <?php echo (isset($mainNav) && $mainNav == 'perfil')? 'class="active"':'' ?>>
          <a href="<?php echo base_url('UsuariosController/viewPerfil') ?>">
            <i class="fa fa-user-circle text-yellow"></i> <span>Perfil</span>
				...
				<li <?php echo (isset($mainNav) && $mainNav == 'helpDesk')? 'class="active"':'' ?>>
          <a href="<?php echo base_url('HelpDeskController/') ?>">
            <i class="fa fa-tags text-blue"></i> <span>COOPDesk</span>
        ...
        <li <?php echo (isset($mainNav) && $mainNav == 'producaoAudioVisual')?'class="active treeview"':'class="treeview"' ?>>
          ...
          <ul class="treeview-menu">
            <li>
              <!--<a href="http://homologacao.cs.canal.fiocruz.br/nova_intranet/home/login/<?php //$this->session->userdata()?>" target="_blank">-->
              <!--<a href="http://localhost/canalintranet/Plataformas/novoFluxo/" target="_blank">-->
              <a href="http://localhost/canalintranet/Plataformas/fluxo/" target="_blank">
            ...
            <li <?php echo (isset($mainNavSub) && $mainNavSub == 'pautas')?'class="active treeview"':'class="treeview"' ?>>
              <a href="#"><i class="fa fa-circle-o text-yellow"></i> Sistema de Pautas
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                 <li <?php echo (isset($subMainNav) && $subMainNav == 'listarPautas')? 'class="active"':'' ?>><a href="<?php echo base_url('PautasController/viewLista') ?>"><i class="fa fa-circle-o text-red"></i> Listar Pautas</a></li>
                 <li <?php echo (isset($subMainNav) && $subMainNav == 'cadastroPauta')? 'class="active"':'' ?>><a href="<?php echo base_url('PautasController/viewCadastro') ?>"><i class="fa fa-circle-o text-yellow"></i> Enviar Roteiro</a></li>
                 <li <?php echo (isset($subMainNav) && $subMainNav == 'cadastroPauta')? 'class="active"':'' ?>><a href="<?php echo base_url('PautasController/viewCadastro') ?>"><i class="fa fa-circle-o text-red"></i> Criar Pauta</a></li>
                 <li <?php echo (isset($subMainNav) && $subMainNav == 'cadastroPautaMatGav')? 'class="active"':'' ?>><a href="<?php echo base_url('PautasController/viewCadastroMatGav') ?>"><i class="fa fa-circle-o text-red"></i> Criar Pauta MAT GAV</a></li>
                 <li <?php echo (isset($mainNavSub) && $mainNavSub == 'pautas')?'class="active treeview"':'class="treeview"' ?>>
                    <a href="#"><i class="fa fa-circle-o text-blue"></i> Depósito de Matérias
                      <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                      </span>
                    </a>
                    <ul class="treeview-menu">
                      <li <?php echo (isset($subMainNav) && $subMainNav == 'cadastroPauta')? 'class="active"':'' ?>><a href="<?php echo base_url('PautasController/viewCadastro') ?>"><i class="fa fa-circle-o text-blue"></i> Matérias Agendadas</a></li>
                      <li <?php echo (isset($subMainNav) && $subMainNav == 'cadastroPautaMatGav')? 'class="active"':'' ?>><a href="<?php echo base_url('PautasController/viewCadastroMatGav') ?>"><i class="fa fa-circle-o text-blue"></i> Mat. Gaveta à Gravar</a></li>
                      <li <?php echo (isset($subMainNav) && $subMainNav == 'cadastroPautaMatGav')? 'class="active"':'' ?>><a href="<?php echo base_url('PautasController/viewCadastroMatGav') ?>"><i class="fa fa-circle-o text-blue"></i> Matérias de Gaveta</a></li>
                      <li <?php echo (isset($subMainNav) && $subMainNav == 'cadastroPautaMatGav')? 'class="active"':'' ?>><a href="<?php echo base_url('PautasController/viewCadastroMatGav') ?>"><i class="fa fa-circle-o text-blue"></i> Matérias Base Limpa</a></li>
                    </ul>
                  </li>
              </ul>
            </li>
            ...
            <li <?php echo (isset($mainNavSub) && $mainNavSub == 'sistemasMidias')?'class="active treeview"':'class="treeview"' ?>>
              ...
              <ul class="treeview-menu">
								 ...
								 <li <?php echo (isset($subMainNav) && $subMainNav == 'listarChamadasCanal')? 'class="active"':'' ?>><a href="<?php echo base_url('midiasParceirosController/viewProgramasParceiros') ?>"><i class="fa fa-circle-o text-yellow"></i> Chamadas Canal Saúde</a></li>
								 ...
								 <li <?php echo (isset($subMainNav) && $subMainNav == 'listarChamadasParceiros')? 'class="active"':'' ?>><a href="<?php echo base_url('midiasChamadasParceirosController/viewChamadasParceiros') ?>"><i class="fa fa-circle-o text-blue"></i> Chamadas Parceiros</a></li>								 
								 <li <?php echo (isset($subMainNav) && $subMainNav == 'listarInterParceiros')? 'class="active"':'' ?>><a href="<?php echo base_url('midiasParceirosController/viewProgramasParceiros') ?>"><i class="fa fa-circle-o text-pink"></i> Inter Pgms Parceiros</a></li>                                 
								 <li <?php echo (isset($subMainNav) && $subMainNav == 'listarInterCanal')? 'class="active"':'' ?>><a href="<?php echo base_url('midiasParceirosController/viewProgramasParceiros') ?>"><i class="fa fa-circle-o text-brown"></i> Inter Pgms Canal Saúde</a></li>                                 
              </ul>
            </li>
          </ul>
        </li>
        ...
        <li><a href="http://www.canal.fiocruz.br/" target="_blank"><i class="fa fa-circle-o text-aqua"></i><span>Site Canal Saúde</span></a></li>
         <li class="header"></li>
      </ul>
